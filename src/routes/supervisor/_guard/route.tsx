...
import {
  ...
  Moon, Sun, Search, PanelLeftClose, PanelLeft, Home, Palette,
} from "lucide-react";
...
function SupervisorLayout() {
  ...
  const { dark, setDark, accent, accentInfo } = useTheme();
  ...
  // Rôle bg (utilise accent utilisateur au lieu de couleur figée)
