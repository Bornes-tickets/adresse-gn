        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <div className="mt-14 grid gap-14 lg:mt-20 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-20">
            <div>
              ...
              {/* ➍ CTA — "Tester une adresse" → "Voir un exemple réel" */}
              <Reveal delay={320}>
              ...
              <div className="relative mx-auto flex max-w-[340px] flex-col items-center">
                ...
                <div className="relative z-[2] aspect-9/19 w-[285px] rotate-[-2deg] overflow-hidden rounded-[2.85rem] border-[9px] border-slate-950 bg-white shadow-[0_40px_90px_-25px_rgba(15,23,42,0.55)] transition-transform duration-500 hover:rotate-0 md:w-[305px]">
                  ...
                  <div className="flex h-full flex-col">
                    ...
                    {/* ➋ Résultat — chip TROUVÉ retiré (redondant avec badge "Adresse retrouvée" au-dessus) */}
                    <div className="space-y-3 bg-white p-4">
                      <div className="rounded-2xl border border-slate-200 bg-white p-3.5 shadow-sm">
                        <div className="min-w-0">
                          ...
                          <p className="mt-1 font-mono text-[11px] font-semibold tracking-wide text-accent">
                            GN-CKY-582741
                          </p>
            ...
            <div className="mt-24 md:mt-32">
              <div className="mx-auto mb-9 max-w-2xl text-center">
                ...
                <h3 className="text-display mt-3 text-2xl font-bold tracking-tight text-slate-950 md:text-3xl">
                  Avant, on expliquait.{" "}
                  <span className="text-accent">Maintenant, on partage.</span>
                </h3>
                ...
                <div className="relative overflow-hidden rounded-[28px] border border-accent/20 bg-gradient-to-br from-accent/[0.07] via-white to-sky-50 p-6 shadow-[0_20px_60px_-30px_rgba(13,148,136,0.35)] md:p-8">
                  ...
                  <div className="relative">
                    ...
                    <p className="mt-2 text-sm text-slate-500">
                      Une référence unique pour retrouver le lieu.
                    </p>
                    <div className="mt-6 space-y-3">
                      {[
          ...
          {/* ➌ Bandeau AVANTAGES — plus contrasté (fond gris, icônes gradient) */}
          <Reveal delay={150}>
            <div className="mt-10 overflow-hidden rounded-[26px] border border-slate-200 bg-slate-50/60 shadow-[0_8px_30px_rgba(15,23,42,0.04)] md:mt-12">
              <div className="grid grid-cols-1 divide-y divide-slate-200/70 sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-4">
                {AVANTAGES.map((avantage) => (
                  <div key={avantage.titre}
                    className="group flex items-center gap-3.5 bg-white/50 p-5 transition-colors hover:bg-white md:p-6">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-0.5 text-xs text-slate-600 md:text-[13px]">
                        {avantage.texte}
                      </p>
                    </div>
                  </div>
            ...
            {USAGES.map((item, index) => (
              <Reveal key={item.cle} delay={index * 80}>
                <div className="group h-full rounded-2xl border border-slate-200 bg-white p-5 transition-all duration-200 hover:-translate-y-1 hover:border-transparent hover:shadow-xl md:p-8">
                  <span className={cn("flex size-11 items-center justify-center rounded-2xl bg-gradient-to-br text-white shadow-md transition-transform group-hover:scale-110 md:size-14", item.grad)}>
        ...
        <Reveal className="mx-auto max-w-5xl">
          <div className="grid overflow-hidden rounded-3xl border border-slate-200 shadow-xl lg:grid-cols-5">
            <div className="gradient-signature-soft p-8 md:p-14 lg:col-span-3">
              ...
              <h2 className="text-display mt-3 text-2xl font-bold tracking-tight text-white md:mt-4 md:text-3xl">{t("home.cta.title")}</h2>
              <p className="mt-3 text-sm leading-relaxed text-white/85 md:mt-4 md:text-base">{t("home.cta.text")}</p>
            ...
            <div className="flex flex-col justify-center bg-white p-6 md:p-10 lg:col-span-2">
              <div className="flex items-center gap-4 rounded-lg bg-slate-100 p-4 md:p-6">
                ...
                <svg viewBox="0 0 21 21" aria-hidden className="size-10 shrink-0 text-slate-900 md:size-12" fill="currentColor">
              ...
              <p className="mt-3 text-xs text-slate-500 md:mt-4">{t("home.cta.plate")}</p>
            </div>
          </div>
        </Reveal>
      </section>
