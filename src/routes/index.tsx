  ...
  return (
    <div className="bg-white">
      ...
      >
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute -right-48 top-32 h-[520px] w-[520px] rounded-full bg-cyan-100/35 blur-[130px]"
        />

        <div
          aria-hidden
          className="pointer-events-none absolute -left-48 bottom-24 h-[460px] w-[460px] rounded-full bg-blue-100/30 blur-[130px]"
        />
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          {/* =================================================
              ÉTAPES + PREUVE PRODUIT
              ================================================= */}

          <div className="mt-14 grid gap-14 lg:mt-20 lg:grid-cols-[0.92fr_1.08fr] lg:items-center lg:gap-16 xl:gap-24">
            {/* ===========================
                ÉTAPES
                =========================== */}
            ...
            <div>
              ...
              <Reveal delay={320}>
                <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                  <Button
                    asChild
                    className="group h-12 rounded-xl bg-gradient-to-r from-accent to-accent-dark px-6 text-sm font-semibold text-accent-foreground shadow-lg shadow-accent/20 transition-all hover:-translate-y-0.5 hover:shadow-accent/30"
                  >
                    <Link
                      to="/a/$number"
                      params={{
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="h-12 rounded-xl border-slate-300 bg-white px-6 text-sm font-semibold text-slate-700 hover:border-slate-400 hover:bg-slate-50"
                  >
                    <Link to="/commander">
            ...
            >
              <div className="relative mx-auto flex max-w-[420px] flex-col items-center">
                ...
                <div
                  aria-hidden
                  className="absolute left-1/2 top-1/2 h-[480px] w-[480px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-br from-accent/20 via-sky-100/45 to-blue-100/20 blur-[85px]"
                />
                ...
                {/* Téléphone */}
                <div className="relative z-[2] aspect-[9/19] w-[300px] rotate-[-2deg] overflow-hidden rounded-[2.9rem] border-[9px] border-slate-950 bg-white shadow-[0_42px_90px_-25px_rgba(15,23,42,0.55)] transition-all duration-500 hover:rotate-0 hover:scale-[1.01] md:w-[325px] xl:w-[340px]">
                  {/* Notch */}
                  <div
                    aria-hidden
                    ...
                    <div className="space-y-3 bg-white p-4">
                      <div className="rounded-2xl border border-slate-200 bg-white p-3.5 shadow-sm">
                        <div className="min-w-0">
                          ...
                          <p className="mt-1 font-mono text-[12px] font-bold tracking-[0.04em] text-accent">
                            GN-CKY-582741
                          </p>
                ...
                {/* Carte flottante partage */}
                <div className="pointer-events-none absolute -left-7 top-28 z-10 hidden rotate-[-5deg] rounded-2xl border border-slate-200 bg-white px-3 py-2.5 shadow-xl md:block xl:-left-12">
                ...
                {/* Carte flottante itinéraire */}
                <div className="pointer-events-none absolute -right-7 bottom-36 z-10 hidden rotate-[5deg] rounded-2xl border border-slate-200 bg-white px-3 py-2.5 shadow-xl md:block xl:-right-12">
                  <div className="flex items-center gap-2">
                    <div className="flex size-7 items-center justify-center rounded-full bg-accent/10">
          ...
          <Reveal delay={100}>
            <div className="mt-24 md:mt-32">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="relative overflow-hidden rounded-[28px] border border-accent/25 bg-gradient-to-br from-accent/[0.10] via-white to-cyan-50 p-6 shadow-[0_22px_65px_-30px_rgba(13,148,136,0.45)] md:p-8">
                  {/* Halo */}
                  <div
                    aria-hidden
                  ...
                  <div className="relative">
                    <p className="font-mono text-2xl font-extrabold tracking-[0.06em] text-slate-950 md:text-[1.7rem]">
                      GN-CKY-582741
                    </p>
          ...
          <Reveal delay={150}>
            <div className="mt-14 overflow-hidden rounded-[26px] border border-slate-200 bg-slate-50/60 shadow-[0_8px_30px_rgba(15,23,42,0.04)] md:mt-16">
              <div className="grid grid-cols-1 divide-y divide-slate-200/70 sm:grid-cols-2 lg:grid-cols-4 lg:divide-x lg:divide-y-0">
                {AVANTAGES.map(
                  (avantage) => (
                    <div
                      key={avantage.titre}
                      className="group flex min-h-[104px] items-center gap-3.5 bg-white/55 p-5 transition-all hover:bg-white md:p-6"
                    >
                      <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-accent to-accent-dark text-white shadow-md shadow-accent/15 transition-transform group-hover:scale-105 md:size-12">
                        <avantage.icone className="size-5" />
                      </div>

                      <div className="min-w-0">
                        <p className="text-sm font-bold text-slate-950 md:text-[15px]">
                          {avantage.titre}
                        </p>

                        <p className="mt-1 text-xs leading-5 text-slate-600 md:text-[13px]">
                          {avantage.texte}
                        </p>
                      </div>
                    </div>
