...
const ETAPES = [
  ...
  { numero: "02", icone: Search, titre: "Saisissez ou scannez", texte: "Entrez le numéro ou scannez le QR Code pour retrouver instantanément l'adresse.", tags: ["Web & mobile", "Android & iOS"], titreCourt: "Scannez" },
  ...
  return (
    <div className="w-full overflow-x-hidden bg-white">
          ...
          <div className="mx-auto mt-6 max-w-[1280px] rounded-[22px] bg-white p-2 shadow-sm ring-1 ring-slate-200/80 md:mt-8 xl:mt-9">
            <form className="flex flex-col gap-2 md:flex-row" onSubmit={(e) => { e.preventDefault(); void rechercher(numero); }}>
              ...
              <Button type="submit" disabled={enCours}
                className="h-12 w-full rounded-2xl bg-accent px-8 text-base font-semibold text-white shadow-sm transition-colors hover:bg-accent-dark active:scale-[0.98] md:w-auto md:min-w-[160px]">
      ...
      <div className="md:hidden">
          ...
          <div className="mx-auto max-w-[430px]">
            <div className="grid grid-cols-2 gap-2.5">
              ...
              >
                ...
                <p className="relative mt-1 text-[10px] leading-4 text-white/78">Obtenir mon Adresse GN</p>
              </Link>
            </div>
          </div>
        </section>
              ...
              <div className="p-3">
                <div className="grid grid-cols-[1.35fr_0.65fr] gap-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex h-10.5 items-center justify-center gap-2 rounded-[13px] bg-accent px-3 text-[10.5px] font-bold text-white shadow-sm transition-colors active:scale-[0.99]"
                  >
              ...
              {USAGES.map((item) => {
                ...
                return (
                  <article
                    key={item.cle}
                    className={cn(
                      "group relative min-h-[126px] overflow-hidden rounded-[18px] border border-slate-200/90 bg-gradient-to-br p-3.5 shadow-[0_10px_28px_-22px_rgba(15,23,42,0.22)]",
                      item.fond,
                    )}
                  >
          ...
          <div className="mx-auto max-w-[430px]">
            ...
            <div className="mt-4 overflow-hidden rounded-[18px] border border-slate-200/90 bg-white shadow-[0_14px_34px_-24px_rgba(15,23,42,0.24)]">
              {[
                {
                  icon: MapPinned,
                  label: "Localisation GPS associée",
                  detail: "Chaque adresse est liée à sa position géographique",
                },
                {
                  icon: Handshake,
                  label: "Accompagnement local",
                  detail: "Assistance disponible selon l’offre choisie",
                },
                {
                  icon: Smartphone,
                  label: "Web, Android & iOS",
                  detail: "Compatible avec Google Maps, Waze et QR Code",
                },
              ].map((item, index) => (
                <div
                  key={item.label}
        ...
        {/* ---------------------------------------------------------------
            7. CTA FINAL — MOBILE CONVERSION / COMPACT
            --------------------------------------------------------------- */}
            ...
            <div className="relative isolate overflow-hidden rounded-[26px] border border-slate-800/70 bg-[#071426] px-4 pb-4 pt-3.5 text-white shadow-[0_24px_55px_-28px_rgba(2,8,23,0.68)]">
              ...
              <div className="relative">
                ...
                <p className="mt-2 text-[10.5px] leading-4 text-white/70">
                  Créez votre Adresse GN et partagez votre localisation en quelques secondes.
                </p>
      ...
      <div className="hidden md:block">
              ...
              <div>
                ...
                <Reveal delay={280}>
                  <div className="mt-5 flex flex-col gap-2.5 sm:flex-row">
                    <Button asChild className="group h-11 rounded-xl bg-accent px-5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-accent-dark">
                    ...
                    <div className="flex h-full flex-col">
                      ...
                      <div className="relative z-20 border-t border-slate-100 bg-white p-3.5">
                        ...
                        <div className="mt-3 grid grid-cols-2 gap-2">
                          <a href={GOOGLE_MAPS_ROUTE_URL} target="_blank" rel="noreferrer" className="group flex h-10 items-center justify-center gap-1.5 rounded-xl bg-accent px-2 text-[9px] font-semibold text-white shadow-sm transition-colors hover:bg-accent-dark">
                            <Navigation2 className="size-3.5" />
                            Google Maps
              ...
              <div className="mt-6 overflow-hidden rounded-[22px] border border-slate-200 bg-slate-50/60 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
                <div className="grid grid-cols-1 divide-y divide-slate-200/70 sm:grid-cols-2 lg:grid-cols-4 lg:divide-x lg:divide-y-0 2xl:grid-cols-4">
                  {AVANTAGES.map((avantage) => (
                    <div key={avantage.titre} className="group flex min-h-[80px] items-center gap-3 bg-white p-4 transition-colors hover:bg-slate-50 md:px-5 md:py-4">
                      <div className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-accent text-white shadow-sm transition-colors group-hover:bg-accent-dark">
                  ...
                  {POINTS_CONFIANCE.map((point, index) => (
                    <Reveal key={point.titre} delay={index * 60}>
                      <article className="group h-full rounded-[20px] border border-slate-200 bg-white p-4 shadow-[0_10px_28px_rgba(15,23,42,0.04)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(15,23,42,0.08)] xl:p-[18px]">
                        <div className="flex items-start justify-between gap-3">
                          <span className="flex size-11 shrink-0 items-center justify-center rounded-2xl bg-accent text-white shadow-sm">
        ...
        <section className="relative w-full overflow-hidden bg-white pb-7 pt-1 sm:pb-8 sm:pt-2 md:pb-8 md:pt-2 xl:pb-9 xl:pt-2">
          <div aria-hidden className="pointer-events-none absolute -left-52 top-1/2 size-[420px] -translate-y-1/2 rounded-full bg-blue-50/35" />
          <div aria-hidden className="pointer-events-none absolute -right-52 top-1/2 size-[420px] -translate-y-1/2 rounded-full bg-cyan-50/35" />
          <Reveal className={cn(SITE_CONTAINER, "relative")}>
            <div className="mx-auto grid w-full max-w-[1660px] overflow-hidden rounded-[22px] border border-slate-200 bg-white shadow-sm sm:rounded-[26px] lg:grid-cols-[1.12fr_0.88fr] xl:rounded-[28px]">
              <div className="relative overflow-hidden gradient-signature-soft px-6 py-6 sm:px-8 md:px-9 lg:px-10 lg:py-6 xl:px-11">
                <div aria-hidden className="absolute -left-20 -top-20 size-56 rounded-full bg-white/[0.04]" />
                ...
                <div className="relative flex h-full flex-col justify-center">
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-2">
                    {["Numéro unique prêt à partager", "QR Code intégré", "Localisation GPS", "Plaque physique en option"].map((item) => (
                      <div key={item} className="flex min-h-10 items-center gap-2 rounded-xl border border-white/15 bg-white/[0.08] px-2.5 py-2 sm:px-3">
                  ...
                  <div className="mt-5 flex flex-col gap-2.5 sm:flex-row sm:items-center">
                    <Button asChild className="group h-12 w-full rounded-xl bg-white px-7 text-sm font-bold text-slate-950 shadow-sm transition-colors hover:bg-slate-50 sm:w-auto sm:min-w-[220px]">
                      <Link to="/commander">
                        Créer mon Adresse GN
                        <ArrowRight className="ml-1 size-4 transition-transform group-hover:translate-x-1" />
                      </Link>
                    </Button>
                    <Button asChild variant="outline" className="h-12 w-full rounded-xl border-white/35 bg-white/[0.04] px-6 text-sm font-semibold text-white transition-colors hover:border-white/60 hover:bg-white/10 hover:text-white sm:w-auto">
              ...
              <div className="relative flex items-center justify-center overflow-hidden bg-white px-5 py-5 sm:px-7 md:px-8 lg:px-7 lg:py-5">
                <div aria-hidden className="absolute -right-20 -top-20 size-60 rounded-full bg-accent/[0.03]" />
                <div aria-hidden className="absolute -bottom-28 -left-20 size-64 rounded-full bg-blue-50/30" />
                <div aria-hidden className="absolute inset-x-16 bottom-10 h-px bg-slate-200/70" />
                <div className="relative w-full max-w-[420px]">
                  <div className="mb-2 flex justify-center">
                    <span className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-[8px] font-bold uppercase tracking-[0.16em] text-slate-700 sm:text-[9px]">
                      <QrCode className="size-3.5 text-accent" /> Aperçu de votre Adresse GN
                    </span>
                  </div>
                  <div className="relative mx-auto w-full max-w-[395px] overflow-hidden rounded-[22px] border border-slate-300/80 bg-white shadow-sm">
                    <div className="gradient-signature-soft px-5 py-3 sm:px-6 sm:py-3.5">
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-2.5">
                          <span className="flex size-8 items-center justify-center rounded-xl bg-white/15"><MapPin className="size-4 text-white" /></span>
                          <div>
